      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="<c:url value="/resources/img/slider/watch1.jpg" />" alt="Wristwatch slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="<c:url value="/resources/img/slider/women1.jpg" />" alt="Women Jeans slide img" />
              </div>
              <div class="seq-title">
                <span data-seq>Save Up to 75% Off</span>                
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="<c:url value="/resources/img/slider/shoes1.jpg" />" alt="Shoes slide img" />
              </div>
              <div class="seq-title">
                <span data-seq>Save Up to 75% Off</span>                
            ...
            <!-- single slide item -->  
             <li>
              <div class="seq-model">
                <img data-seq src="<c:url value="/resources/img/slider/collection1.jpg" />" alt="Male Female slide img" />
              </div>
              <div class="seq-title">
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    ...
                    <li><a href="#sports" data-toggle="tab">Sport Shoes</a></li>
                  </ul>
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/man/t-shirt-1.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                             <figcaption>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/man/polo-shirt-5.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span>
                    ...
                    <div class="tab-pane fade" id="women">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/women/girl-2.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/women/girl-5.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/women/girl-6.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/women/girl-7.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                    ...
                    <div class="tab-pane fade" id="sports">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-1.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">This is Title</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-2.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-3.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-4.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-5.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-6.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-7.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<c:url value="/resources/img/sports/sport-8.png" />" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                              <span class="aa-product-price">$45.50</span>
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="<c:url value="/resources/img/fashion-banner.jpg" />" alt="fashion banner img"></a>
          </div>
          </div>
        </div>
      </div>
