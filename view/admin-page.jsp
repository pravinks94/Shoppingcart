         ...
         <div class="cart-view-area">
           <div class="cart-view-table">
             <td colspan="6" class="aa-cart-view-bottom">
                          <input class="aa-cart-view-btn" type="submit" value="Category">
                        </td><td colspan="6" class="aa-cart-view-bottom">
                          <input class="aa-cart-view-btn" type="submit" value="Product">
                        </td><td colspan="6" class="aa-cart-view-bottom">
                          <input class="aa-cart-view-btn" type="submit" value="Supplier">
                        </td>
  <!-- footer -->  
  <footer id="aa-footer">
    <!-- footer bottom -->
