        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="#">Shoes <span class="caret"></span></a>
                <ul class="dropdown-menu">                
                  <li><a href="#">Sandals</a></li>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#">Puma</a></td>
                        <td>Noida</td>
						<td>.......................,Noida</td>
                      ...
                      <tr>
                        <td>2</td>
                        <td><a href="#"><img src="img/man/polo-shirt-1.png" alt="img"></a></td>
                        <td><a class="aa-cart-title" href="#">Adidas</a></td>
                        <td>Noida</td>
						<td>.......................,Noida</td>
                        <td><input class="aa-cart-quantity" type="number" value="1"></td>
                        <td><a class="remove" href="#"><fa class="fa fa-close"></fa></a></td>
					  ...
					  <tr>
                        <td>3</td>
                        <td><a href="#"><img src="img/man/polo-shirt-1.png" alt="img"></a></td>
                        <td><a class="aa-cart-title" href="#">Nike</a></td>
                        <td>Noida</td>
						<td>.......................,Noida</td>
                        <td><input class="aa-cart-quantity" type="number" value="1"></td>
                        <td><a class="remove" href="#"><fa class="fa fa-close"></fa></a></td>
					  ...
					  <tr>
                        <td colspan="6" class="aa-cart-view-bottom">
                          <input class="aa-cart-view-btn" type="submit" value="Add New Supplier">
                        </td>
                      </tr>
                      </tbody>
                  </table>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      <p> NiiT Porur</p>
                      <p><span class="fa fa-phone"></span>+1 9840310767</p>
